...
public class FormCourse extends javax.swing.JDialog {

    DefaultTableModel model = new DefaultTableModel();

    public FormCourse(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public FormCourse() throws Exception {
        setModal(true);
        initComponents();
        txTim.requestFocus();
//        this.LoadDSCourse();
...
//    }//GEN-LAST:event_btTimMouseClicked
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormCourse dialog = null;
                try {
                    dialog = new FormCourse();
                } catch (Exception ex) {
